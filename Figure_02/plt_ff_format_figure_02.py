#!/usr/bin/env python3
"""
Fano Factor heatmap — formatted to match Figure 02 layout.

Input : all_metrics.csv  (columns: noise, coupling, fano_factor, ...)
Output: formatted_ff_metric.png
"""
...
OUTPUT_FILE = "formatted_ff_metric.png"
METRIC_COL  = "fano_factor"
...
def plot_mfr_heatmap(df):
    ...
    cbar.set_label(r"$\mathrm{FF}$", fontsize=16)
