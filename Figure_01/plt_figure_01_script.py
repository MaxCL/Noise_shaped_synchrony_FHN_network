#!/usr/bin/env python3
"""
Figure 01 — converted from Figure_01/Figure_01_FHN.ipynb (GitHub repo).
All parameters and file paths are hardcoded.
Output: figure01_from_git.png
"""
...
def plot_panel(ax, u_tup, v_tup, cfg, is_bottom=False):
    ...
    Cs0 = unit([Cu0, Cv0]) * _L;  Ls0 = unit([Lu0, Lv0]) * _L;  Ns0 = unit([0.0, s0]) * _L
...
def main():
    ...
    plt.tight_layout()
    plt.savefig("figure01_from_git.png", bbox_inches="tight", dpi=700)
    print("Saved figure01_from_git.png")
