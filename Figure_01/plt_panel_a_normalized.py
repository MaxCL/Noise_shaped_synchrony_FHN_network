#!/usr/bin/env python3
"""
Panel (a) only — normalized vectors. Matches panel (a) of figure01_from_git.png.
Output: panel_a_normalized.png
"""
...
def main():
    ...
    plot_panel(ax, uA, vA, PANEL_A, is_bottom=True)
    plt.tight_layout()
    plt.savefig("panel_a_normalized.png", bbox_inches="tight", dpi=700)
    print("Saved panel_a_normalized.png")
